...
const setPageNumber = (function ()
{
	...
	const deleteFavorBts=contentElement.getElementsByClassName("deleteFavorBt");
	const deleteFavorForm=document.getElementById("deleteFavorForm");
	const deleteFavorInput=document.getElementById("imgToBeDeletedID");
	return function (pageIndex) // if there are n pages , than pageIndex can be : 0 , 1 , 2 , ...... , n-1
	{
		...
		for (let i = 0; i < 6; i++)
		{
			...
			} catch (e)
			{
				...
				deleteFavorBts[i].imageID=undefined;
				deleteFavorBts[i].onclick=function ()
				{
